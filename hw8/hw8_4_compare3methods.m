...
legend({'Ridge with polynomial kernel', 'Ridge with Gaussian kernel', 'Least square'}, 'fontsize', 15)
title('Compare ridgre regression with different kernels', 'fontsize', 15)
